...
import static com.auth.springbackend.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    OAuth2AuthenticationSuccessHandler(JwtTokenProvider tokenManager, AppProperties appProperties,
